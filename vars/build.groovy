def call() {
    ...
    withCredentials([usernamePassword(credentialsId: 'docker_cred', passwordVariable: 'PASSWORD', usernameVariable: 'USERNAME')]) {
        sh """
            ...
            docker build -t muhammadatef/badreadsclient-$BRANCH_NAME-$BUILD_NUMBER -f ./Dockerfile-front
            docker build -t muhammadatef/badreadsserver-$BRANCH_NAME-$BUILD_NUMBER -f ./Dockerfile-back
